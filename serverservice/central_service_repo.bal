isolated service class StaffRepository {
    ...
    private table<Office> key(office_number) offices = table [
        {office_number: "Office1", list_of_staff_numbers: []},
        {office_number: "Office2", list_of_staff_numbers: []},
        {office_number: "Office3", list_of_staff_numbers: []},
        {office_number: "Office4", list_of_staff_numbers: []}
    ];
    private table<Course> key(course_code) courses = table [
        {course_code: "PLU", course_name: "Principles of english language use", nqf_level: 7},
        {course_code: "PRG", course_name: "Programming", nqf_level: 7},
        {course_code: "OPS", course_name: "Operating Systems", nqf_level: 7},
        {course_code: "DPG", course_name: "Database Programming", nqf_level: 7}
    ];
